...
export default async function VerifyPage() {
  // Auth is handled by the (td-operator) layout. We still read the operator to
  // stamp verifier identity.
  ...
  return (
    <>
      ...
      <OperatorClient rows={rows} operatorLabel={operator?.email ?? operator?.id ?? 'operator'} />
    </>
  )
}
